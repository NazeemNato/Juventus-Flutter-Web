...
class DobHomeScreen extends StatefulWidget {
  DobHomeScreen({Key key, @required this.dob}) : super(key: key);
  final String dob;
  @override
  _DobHomeScreenState createState() => _DobHomeScreenState();
}

class _DobHomeScreenState extends State<DobHomeScreen> {
          ...
          children: <Widget>[
            Expanded(
              child: playerData.isEmpty
                  ...
                  style: TextStyle(fontFamily: 'jrc',fontSize: 30),
                  ))
                  : ListView.builder(
          ...
          children: <Widget>[
            ...
            child:Container(
              child:Column(
                ...
                children: <Widget>[
                Expanded(child: Text('$name',style:  TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold,fontFamily: 'jrc'))),
              SizedBox(height: 2,),
                Text('$position',style:  TextStyle(fontSize: 15, color: Colors.white60,
                fontFamily: 'jrc')),
                Text('$dob',style:  TextStyle(fontSize: 15.0, color: Colors.white60,fontFamily: 'jrc')),
              ],)
            )
            )
          ],
